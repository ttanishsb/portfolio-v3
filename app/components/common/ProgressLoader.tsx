...
const ProgressLoader = ({ progress }: { progress: number }) => {
  ...
  return (
    ...
    <div
      className="fixed top-0 left-0 w-full h-full flex items-center justify-center pointer-events-none transition-opacity duration-500"
      style={{ padding: '1rem', opacity: progress === 100 ? 0 : 1 }}
    >
      <svg
